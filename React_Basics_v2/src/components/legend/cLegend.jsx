    ...
    return (
        <>
            <section id="home" className="col-12 d-flex align-items-center justify-content-between p-2 pb-4 mb-4">
                <div className="legend_desc col-12 col-lg-5 ps-1 d-flex flex-column align-items-start justify-content-between">
                    <div className="name_n_tag">
                        <h2 className="border">Gift Nestah</h2>
                        <span className="my_tags">Software Developer</span>
                    </div>
                    <p className="col-md-11 mx-md-auto">
